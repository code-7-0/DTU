...
void Flash_Factory(void)
{
	  ...
	  strcpy( Device_Flash.QMTSUB4,"/sys/i60d1iPGj1Pl/lhGP0rlsr5COaGog/thing/event/firmware/post");
		...
		strcpy( Device_Flash.QMTSUB6,"/sys/i60d1iPGj1Pl/lhGP0rlsr5COaGog/thing/event/tempercontrol/distribution");
		strcpy( Device_Flash.QMTSUB7,"/sys/i60d1iPGj1Pl/lhGP0rlsr5COaGog/thing/event/tempercontrol/upload");
...
//					  debug_printf("恢复出厂设置！\r\n");
				...
				else  //读取
				{
				  ...
				  bk_flash_Read_uint8(flash_addr,(uint8_t*)Device_Flash.clientId,128);flash_addr+=128;
					...
					bk_flash_Read_uint8(flash_addr,(uint8_t*)Device_Flash.QMTSUB6,128);flash_addr+=128;
					bk_flash_Read_uint8(flash_addr,(uint8_t*)Device_Flash.QMTSUB7,128);flash_addr+=128;					
//	  strcpy( Device_Flash.QMTSUB4,"/sys/i60d1iPGj1Pl/lhGP0rlsr5COaGog/thing/event/firmware/post");
//		strcpy( Device_Flash.QMTSUB5,"/ota/device/upgrade/i60d1iPGj1Pl/lhGP0rlsr5COaGog/");						
					 ...
					 debug_printf("QMTSUB6:     %s\r\n", Device_Flash.QMTSUB6);
					 debug_printf("QMTSUB7:     %s\r\n", Device_Flash.QMTSUB7);						 
				}
}
