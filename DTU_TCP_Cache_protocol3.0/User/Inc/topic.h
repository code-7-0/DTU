...
#define GASPOWER_DAT_UPLOAD_DELAY 	20//10    //主动上报周期通常为5秒
#define DAT_UPLOAD_DELAY_LIVE 	 4     //主动上报周期通常为2秒(活跃) 壁挂炉回复时间等待
#define TEMPER_DAT_UPLOAD_DELAY 	30    //主动上报周期通常为10min
//#define TEMPER_DAT_UPLOAD_DELAY_LIVE 	4    //主动上报周期通常为2秒(活跃)
